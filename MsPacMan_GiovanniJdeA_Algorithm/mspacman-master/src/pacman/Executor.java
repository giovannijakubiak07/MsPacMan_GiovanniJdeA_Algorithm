...
import pacman.controllers.examples.StarterPacMan_GiovanniJA;
import pacman.controllers.examples.oiler;
...
//		exec.runGame(new StarterPacMan(), new Legacy2TheReckoning(), visual,delay);
		...
		/* Meu modo de jogo. */
		//System.out.println("STARTER PACMAN DO GIOVANNI vs LEGACY2THERECKONING");
		exec.runGame(new StarterPacMan_GiovanniJA(), new RandomGhosts(), visual,delay);
		//exec.runExperiment(new StarterPacMan_GiovanniJA(), new AggressiveGhosts(), numTrials);
