...
public final class Game {
	 ...
	 * Tempo que o fantasma vai gastar no covil 
	 * @param ghostType
	 *            the ghost type
	 ...
	 * Retorna a distância do PATH de qualquer nó para qualquer outro nó.
	 * @param fromNodeIndex
	 *            the from node index
	 * @param toNodeIndex
	 *            the to node index
	 ...
	 * mazes[gs.curMaze].
	 * elimina a distância EUCLEDIAN entre dois nós nos labirintos atuais [gs.curMaze].
	 * @param fromNodeIndex
	 *            the from node index
	 * @param toNodeIndex
	 *            the to node index
	 ...
	 * Retorna a distância entre dois nós considerando inversões.
	 * @param fromNodeIndex
	 ...
	 * Obtém o índice de nó mais próximo do índice do nó.
	 * @param fromNodeIndex
	 *            the from node index
	 ...
	 * Obtém o índice de nó mais distante do índice do nó.
	 * @param fromNodeIndex
	 *            the from node index
	 * @param targetNodeIndices
	 *            the target node indices
	 ...
	 * Obtem o proximo movimento longe do alvo
	 * @param fromNodeIndex
	 *            the from node index
	 * @param toNodeIndex
	 *            the to node index
	 ...
	 * Obtém o próximo movimento aproximado em direção ao alvo, sem considerar 
	 * as direções opostas ao último movimento feito.
	 * @param fromNodeIndex
	 ...
	 * Obtém o próximo movimento aproximado longe de um alvo que não considera
	 *  direções opostas ao último movimento feito.
	 * @param fromNodeIndex
	 *            The node index from which to move (i.e., current position)
	 * @param toNodeIndex
	 *            The target node index
	 ...
	 * Obtém o próximo passo em direção ao objetivo, levando em consideração as reversões.
	 *  Isso usa os caminhos pré-calculados.
	 * @param fromNodeIndex
	 *            The node index from which to move (i.e., current position)
	 * @param toNodeIndex
	 *            The target node index
	 ...
	 * This uses the pre-computed paths.
	 * 	Obtém o próximo movimento exato longe do alvo, levando em conta as inversões. 
	 *  Isso usa os caminhos pré-calculados.
	 * @param fromNodeIndex
	 *            The node index from which to move (i.e., current position)
	 * @param toNodeIndex
	 ...
	 * are ignored)
	 * Obtém o caminho A * considerando os movimentos anteriores feitos
	 * @param fromNodeIndex
	 *            The node index from which to move (i.e., current position)
	 * @param toNodeIndex
	 *            The target node index
	 ...
	 * indices.
	 * Obtém o caminho mais curto do nó A para o nó B, conforme especificado pelos seus índices.
	 * @param fromNodeIndex
	 ...
	 * costly.
	 * Obtém o caminho mais curto levando em conta o último movimento feito (ou seja, sem reversões).
	 *  Isso é aproximado apenas quando o caminho é calculado avidamente. 
	 *  Um caminho mais preciso pode ser obtido usando A *, que é um pouco mais custoso.
	 *  
	 * @param fromNodeIndex
	 *            The node index from where to start (i.e., current position)
	 * @param toNodeIndex
